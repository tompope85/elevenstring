...
- Kernel (invariant): distinction, iteration-identity, perspective, coherence-constraint. The minimum machinery any framework needs to be expressible.
...
- Handshakes (protocol): structured inter-agent interaction with declared profiles, capabilities, constraints, trust dimensions.
- Coordinates: time / space / perspective for querying any record.
- Trace: temporally-extended record of typed encounters and module evolution.
